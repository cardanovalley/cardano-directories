(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function xVd(module, __webpack_exports__, __webpack_require__) {
      ...
      var StoresService = /*#__PURE__*/function () {
        function StoresService(http) {
          ...
          this.postUrl = 'http://localhost:8000/stores/';
        }

        _createClass(StoresService, [{
          key: "getStores",
          value: // private storesUrl = 'https://testing-cardano-back.herokuapp.com/stores/?format=json';
          ...
          key: "postStore",
          value: function postStore(store) {
            return this.http.post(this.postUrl, store);
          }
        }]);
    ...
    "N/jP":
    /*!************************************************************!*\
      !*** ./src/app/add-your-store/add-your-store.component.ts ***!
      \************************************************************/

    /*! exports provided: AddYourStoreComponent */

    /***/
    function NJP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AddYourStoreComponent", function () {
        return AddYourStoreComponent;
      });
      /* harmony import */
      ...
      function AddYourStoreComponent_option_21_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngValue", country_r3.url);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", country_r3.name, " ");
        }
      }

      function AddYourStoreComponent_option_59_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "option", 22);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngValue", country_r4.url);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", country_r4.name, " ");
        }
      }

      function AddYourStoreComponent_option_100_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "option", 22);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngValue", country_r5.url);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", country_r5.name, " ");
        }
      }

      var AddYourStoreComponent = /*#__PURE__*/function () {
        function AddYourStoreComponent(_loading, formBuilder, storesService, countriesService) {
          _classCallCheck(this, AddYourStoreComponent);

          this._loading = _loading;
          this.formBuilder = formBuilder;
          this.storesService = storesService;
          this.countriesService = countriesService;
          this.countries = {}; // This is a key:value list with country 'name' and
        ...
        _createClass(AddYourStoreComponent, [{
          key: "onFileChanged",
          ...
          key: "postStore",
          value: function postStore(myStore) {
            this.storesService.postStore(myStore).subscribe();
          }
        }, {
          key: "getCountries",
          value: function getCountries() {
            ...
            this.countriesService.getCountries().subscribe(function (data) {
          ...
          value: function onSubmit() {
            var myFormValue = this.addStoreForm.value;
            var myFormData = new FormData();
            this.addStoreForm.reset();
            this.fileName = '';

            for (var _i = 0, _Object$entries = Object.entries(myFormValue); _i < _Object$entries.length; _i++) {
      ...
      AddYourStoreComponent.ɵfac = function AddYourStoreComponent_Factory(t) {
        return new (t || AddYourStoreComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_loading_service__WEBPACK_IMPORTED_MODULE_2__["LoadingService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_stores_service__WEBPACK_IMPORTED_MODULE_3__["StoresService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_countries_service__WEBPACK_IMPORTED_MODULE_4__["CountriesService"]));
      };

      AddYourStoreComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: AddYourStoreComponent,
        selectors: [["app-add-your-store"]],
        decls: 117,
        vars: 8,
        consts: [[1, "form"], [1, "form-add-store"], ["id", "store-name", "placeholder", "Ex: Cardano Software Factory", "type", "text", "formControlName", "name"], ["id", "website", "placeholder", "Ex: https://cardansoftware.com", "type", "text", "formControlName", "website"], ["id", "address", "placeholder", "Ex: 706 Rosewood Dr, Palo Alto, CA", "type", "text", "formControlName", "address"], ["id", "googlemaps", "placeholder", "Ex: https://goo.gl/maps/HDDgTHh14mS74adg9", "type", "text", "formControlName", "googlemaps_link"], ["id", "country", "formControlName", "country", 1, "select-css"], [3, "ngValue", 4, "ngFor", "ngForOf"], ["for", "image", 1, "custom-file-upload"], [1, "fa", "fa-cloud-upload"], ["id", "image", "type", "file", "formControlName", "picture", 3, "change"], ["id", "add-store", 1, "add-your-store"], [1, "container"], [1, "add-your-store-txt"], [3, "formGroup", "ngSubmit"], [1, "add-your-store-box"], [1, "add-your-store-form"], [1, "single-add-your-store-form"], [1, "single-add-your-store-form", "row"], [1, "add-your-store-form-select"], [1, "add-your-store-form-upload"], ["type", "sumbit", 1, "add-your-store-btn", 3, "disabled"], [3, "ngValue"]],
        template: function AddYourStoreComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](7, "Website:");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](15, "Google Maps Link:");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](20, "select", 6);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](21, AddYourStoreComponent_option_21_Template, 2, 2, "option", 7);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](27, " Upload image ");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](28, "input", 10);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function AddYourStoreComponent_Template_input_change_28_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](31, "section", 11);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](35, "add your store");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](36, "p");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](37, " Add your store, business, or art gallery to PayAda Directories and be found all over the world ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](38, "section", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](42, "input", 2);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](45, "Website:");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](50, "input", 4);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](53, "Google Maps Link:");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](54, "input", 5);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](58, "select", 6);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](59, AddYourStoreComponent_option_59_Template, 2, 2, "option", 7);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](62, "Image");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](65, " Upload image ");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](66, "input", 10);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function AddYourStoreComponent_Template_input_change_66_listener($event) {
              return ctx.onFileChanged($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](69, "form", 14);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function AddYourStoreComponent_Template_form_ngSubmit_69_listener() {
              return ctx.onSubmit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](75, "input", 2);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](80, "Website");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](81, "input", 3);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](86, "Address");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](87, "input", 4);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](92, "Googlemaps Link (optional)");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](93, "input", 5);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](98, "Country (optional)");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](99, "select", 6);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](100, AddYourStoreComponent_option_100_Template, 2, 2, "option", 7);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](105, "Image (optional)");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](106, "label", 8);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](107, "i", 9);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](108, " Upload image ");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](109, "input", 10);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function AddYourStoreComponent_Template_input_change_109_listener($event) {
              return ctx.onFileChanged($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](113, "Complete the required fields to add your store");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](114, "div", 15);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](115, "button", 21);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](116, "Add Store");
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("formGroup", ctx.addStoreForm);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("disabled", !ctx.addStoreForm.valid);
          }
        },
        ...
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhZGQteW91ci1zdG9yZS5jb21wb25lbnQuY3NzIn0= */"]
      });
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _add_your_store_add_your_store_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./add-your-store/add-your-store.component */
      "N/jP");
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "app-add-your-store");
          }
        },
        directives: [_store_list_store_list_component__WEBPACK_IMPORTED_MODULE_2__["StoreListComponent"], _add_your_store_add_your_store_component__WEBPACK_IMPORTED_MODULE_3__["AddYourStoreComponent"]],
    ...
    /***/
    function Y6iY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CountriesService = /*#__PURE__*/function () {
        function CountriesService(http) {
          ...
          this.http = http;
          this.attempts = 0;
          this.countriesUrl = 'http://localhost:8000/countries/?format=json';
        }

        _createClass(CountriesService, [{
          key: "getCountries",
          value: // private countriesUrl = 'https://testing-cardano-back.herokuapp.com/countries/?format=json';
          // private countriesUrl = 'https://cardano-directory-back.herokuapp.com/countries/?format=json';
          function getCountries() {
            var _this3 = this;

            return this.http.get(this.countriesUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (data) {
              _this3.attempts = 0;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (err) {
              if (err.status === 0 && _this3.attempts === 0) {
                _this3.attempts += 1;
      ...
      CountriesService.ɵfac = function CountriesService_Factory(t) {
        return new (t || CountriesService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]));
      };

      CountriesService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _store_list_store_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./store-list/store-list.component */
      "smD0");
      /* harmony import */


      var _http_request_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./http-request-interceptor */
      "eIeQ");
      /* harmony import */


      var _add_your_store_add_your_store_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./add-your-store/add-your-store.component */
      "N/jP");
      /* harmony import */
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineInjector"]({
        providers: [{
          ...
          useClass: _http_request_interceptor__WEBPACK_IMPORTED_MODULE_7__["HttpRequestInterceptor"],
          multi: true
        }],
        imports: [[_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _store_box_store_box_component__WEBPACK_IMPORTED_MODULE_5__["StoreBoxComponent"], _store_list_store_list_component__WEBPACK_IMPORTED_MODULE_6__["StoreListComponent"], _add_your_store_add_your_store_component__WEBPACK_IMPORTED_MODULE_8__["AddYourStoreComponent"]],
          imports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]
        });
      })();
      /***/
        ...
        _createClass(HttpRequestInterceptor, [{
          ...
          value: function intercept(request, next) {
            ...
            return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
              _this4._loading.setLoading(false, request.url);
    ...
    function qOGq(module, __webpack_exports__, __webpack_require__) {
      ...
      function StoreBoxComponent_div_19_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](ctx_r5.store.country_name);
        }
      }
      ...
      StoreBoxComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function StoreBoxComponent_Template(rf, ctx) {
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.store.country_name);
        ...
        _createClass(StoreListComponent, [{
          ...
          value: function getStores(url) {
            ...
            this.storesService.getStores(url).subscribe(function (data) {
              _this5.storeList = data['results'];
              _this5.paginationNext = data['next'];
              _this5.paginationPrevious = data['previous'];
              _this5.numberOfPages = Math.ceil(data['count'] / 9); // Extraction ofthe current page number from "next page" link

              if (_this5.paginationNext !== null) {
                _this5.currentPage = Number(_this5.paginationNext.split('page=')[1]) - 1;
                _this5.paginationAddress = _this5.paginationNext.split('page=')[0];
              } else {
                _this5.currentPage = _this5.numberOfPages;
              } // Selection of the page numbers to be displayed on the pagination nav


              _this5.pagesShown = []; // We reset the list on every API call
              // Set initializer and end condition for pages loop

              if (_this5.numberOfPages <= 5 || [1, 2].includes(_this5.currentPage)) {
                _this5.initializer = 1;
                _this5.endCondition = Math.min(_this5.numberOfPages, 5);
              } else if ([_this5.numberOfPages, _this5.numberOfPages - 1].includes(_this5.currentPage)) {
                _this5.initializer = _this5.currentPage - 4;
                _this5.endCondition = _this5.numberOfPages;
              } else {
                _this5.initializer = _this5.currentPage - 2;
                _this5.endCondition = _this5.currentPage + 2;
              } // Set pages to be shown with corresponding API address


              for (var i = _this5.initializer; i <= _this5.endCondition; i++) {
                _this5.pagesShown.push({
                  "number": i,
                  "address": "".concat(_this5.paginationAddress, "page=").concat(i)
                });
              }
            }, function (err) {
              console.log(err);
